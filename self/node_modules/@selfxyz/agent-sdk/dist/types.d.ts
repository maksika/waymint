...
export type VerifyResult = {
    ...
    verified: false;
    reason: "NOT_REGISTERED" | "NO_HUMAN_PROOF";
} | {
    verified: false;
...
export declare const EXPIRY_WARNING_THRESHOLD_SECS: number;
/**
 ...
 */
export declare function isProofExpiringSoon(expiresAt: Date, thresholdSecs?: number): boolean;
